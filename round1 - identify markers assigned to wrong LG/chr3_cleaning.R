...
rf_chr.df$outliers <- 0
rf_chr.df$outliers[c(5, 11, 20, 23, 24, 25, 26,
                     28, 30, 58, 67, 88, 142, 148, 149,
                     188, 199, 200, 201, 202, 203, 204,
                     205, 206, 207, 208)] <- 1
...
newmap <- est.map(cross20.chr.rmOutliers, error.prob=0.005, offset = 0)
