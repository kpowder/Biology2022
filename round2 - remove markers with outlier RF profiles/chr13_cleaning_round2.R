...
rf_chr.df$outliers <- 0
rf_chr.df$outliers[c(6, 12, 22, 27, 30, 32, 33, 36, 37, 42, 51,
                     61, 65, 70, 80, 82, 84, 85, 86, 88, 89, 90,
                     96, 100, 103, 108, 109, 113, 115, 117, 118,
                     120, 128, 130, 135, 136, 145, 162, 163, 167,
                     183, 200, 204, 205, 206, 210, 220, 222, 241)] <- 1
