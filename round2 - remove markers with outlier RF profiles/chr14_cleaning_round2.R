...
load("../cross20.chr1.rmOutliers.rmRM.Rdata")
...
rf_chr.df$outliers <- 0
rf_chr.df$outliers[c(6, 10, 12, 16, 22, 30, 31, 35, 37, 41, 46, 
                     49, 51, 53, 70, 71, 72, 73, 76, 81, 87, 89,
                     96, 100, 104, 106, 110, 112, 128, 135, 139,
                     141, 152, 161, 162, 173, 177, 181, 187, 
                     190, 198, 209, 216, 217, 229, 231, 241,
                     247, 249)] <- 1
