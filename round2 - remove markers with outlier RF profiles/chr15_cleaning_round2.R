...
rf_chr.df$outliers <- 0
rf_chr.df$outliers[c(3, 4, 5, 6, 11, 13, 16, 17, 18, 20, 23, 24,
                     28, 30, 35, 36, 38, 40, 42, 44, 45, 49, 53,
                     59, 65, 73, 80, 82, 86, 97, 98, 100, 102,
                     108, 110, 112, 115, 121, 127, 129, 130, 137,
                     149, 150, 151, 158, 162, 174)] <- 1
