...
rf_chr.df$outliers <- 0
rf_chr.df$outliers[c(20, 24, 29, 33, 34, 37, 38, 39, 44, 45,
                     57, 59, 60, 62, 65, 67, 68, 73, 74, 78,
                     87, 96, 98, 104, 105, 106, 118, 120, 
                     126, 130, 131, 154, 157, 170, 177, 183)] <- 1
...
missassembled_markers <- mean_rf.df[mean_rf.df$mean_rf < 0.3,]
