...
#png(paste("RFplots_362ind-maxmissingdata-0.2.chr", 
#          chr, "vsAll.rf.png", sep = ""))
#for(i in 1:22){
...
rf_chr.df$outliers <- 0
rf_chr.df$outliers[c(2, 5, 21, 22, 24, 26, 28, 36, 37, 39,
                     48, 50, 53, 55, 59, 68, 80, 81, 85, 89,
                     96, 98, 101, 109, 112, 113, 115, 117,
                     118, 119, 120, 125, 126, 127, 131, 137, 140,
                     142, 151, 156, 160, 164, 165, 166, 168,
                     170, 172, 174, 176, 179, 180, 189, 191,
                     192, 194, 197, 198, 202, 203, 214, 224,
                     226, 231, 232, 234, 235, 237, 240, 241,
                     245)] <- 1
