...
rf_chr.df$outliers <- 0
rf_chr.df$outliers[c(1, 3, 5, 8, 15, 17, 27, 30, 32, 34, 36, 40,
                     41, 46, 47, 48, 52, 53, 55, 57, 60, 62, 63,
                     65, 68, 69, 78, 80, 82, 83, 84, 85, 89, 94,
                     95, 97, 98, 99, 103, 104, 105, 108, 109, 112,
                     122, 127, 130, 134, 136, 139, 143, 148, 151,
                     155, 161, 165, 175, 181, 185, 189, 192, 196)] <- 1
