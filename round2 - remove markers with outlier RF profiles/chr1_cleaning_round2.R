...
#load("Robjects_round2_genetic_map_building_LcLt3492.RData")
...
rf_chr.df$outliers <- 0
rf_chr.df$outliers[c(2, 4, 5, 11, 18, 21, 26, 40, 45, 47,
                     49, 50, 53, 55, 56, 58, 61, 64,
                     68, 69, 73, 79, 82, 90, 96, 98,
                     99, 109, 114, 116, 119, 123, 124, 132,
                     142, 152, 157, 163, 165, 168, 173,
                     204, 214, 216)] <- 1
