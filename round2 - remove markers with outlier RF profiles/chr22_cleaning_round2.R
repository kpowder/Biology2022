...
rf_chr.df$outliers <- 0
rf_chr.df$outliers[c(3, 4, 6, 7, 8, 10, 11, 13, 14, 16, 18, 19, 
                     26, 32, 33, 35, 37, 41, 42, 44, 49, 50, 53,
                     54, 58, 61, 62, 65, 67, 68, 70, 71, 77, 79,
                     81, 82, 83, 86, 87, 91, 98, 99, 100, 103, 
                     105, 107, 112, 113, 116, 117, 118, 121, 122,
                     126, 127, 146, 147, 151, 152, 153, 154, 158, 
                     160, 161, 162, 163, 166, 167, 169, 171, 173, 
                     175, 176, 177, 179, 182, 187, 188, 189, 191,
                     196, 197, 200, 203, 204, 207, 212, 215, 220, 
                     221, 225, 227, 230, 233, 237, 238, 240, 242, 
                     245, 246, 247, 249, 254, 255, 257, 260, 262, 
                     264, 265, 268, 269, 271, 275, 281, 283)] <- 1
...
mean_rf.df <- data.frame(marker = "x", index = 0, chr1 = 0, chr2 = 0, chr3 = 0, chr4 = 0,
                         ...
                         chr17 = 0, chr18 = 0, chr19 = 0, chr20 = 0, chr21 = 0, chr22 = 0, 
