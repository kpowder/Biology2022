...
#load("../cross20.chr5.rmOutliers.rmRM.Rdata")
...
rf_chr.df$outliers <- 0
rf_chr.df$outliers[c(1, 2, 5, 8, 10, 13, 22, 26, 30, 35, 39, 40, 47, 
                     51, 52, 55, 59, 65, 66, 68, 69, 72, 76, 78, 82, 
                     91, 93, 98, 103, 105, 107, 109, 112, 116, 117, 
                     118, 125, 128, 136, 139, 146, 165, 170, 174, 
                     180, 190, 193)] <- 1
