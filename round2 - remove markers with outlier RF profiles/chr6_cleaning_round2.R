...
load("../cross20.chr6.rmOutliers.rmRM.Rdata")
...
rf_chr.df$outliers <- 0
rf_chr.df$outliers[c(2, 11, 19, 21, 25, 33, 41, 45, 53, 59, 65, 66, 69,
                     73, 75, 77, 89, 103, 105, 107, 119, 121, 134, 135, 
                     140, 142, 144, 146, 147, 148, 150, 154, 156, 157,
                     159, 160, 161, 164, 171, 178, 179, 183, 185, 187,
                     192, 194, 199, 204, 207, 208)] <- 1
