...
#load("../cross20.chr8.rmOutliers.rmRM.Rdata")
...
rf_chr.df$outliers <- 0
rf_chr.df$outliers[c(1, 6, 35, 80, 86, 89, 91, 93, 99, 105, 
                     111, 115, 116, 119, 126)] <- 1
...
# plot Map
pdf(paste("map_plots_chr", chr, "_round2.pdf", sep = ""))
par(mfrow=c(1,2))
...
pdf(paste("summary_plots_362ind-maxmissingdata0.2.chr", chr, ".round2.pdf", sep = ""))
par(mfrow=c(1,1))
